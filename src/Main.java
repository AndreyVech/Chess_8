...
//сделаем функцию текстовой и добавим проверку условия конца игры
                        if (board.moveToPosition(line, column, toLine, toColumn).equals("true")) {
                            System.out.println("Успешно передвинулись");
                            board.printBoard();
                        } else if (board.moveToPosition(line, column, toLine, toColumn).equals("false")) {
                            System.out.println("Передвижение не удалось");
                        } else {
                            System.out.println("шах и мат! конец игры");
                            break;
                        }
                        ;
                    } catch (Exception e) {
